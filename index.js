...
async function init() {
 ...
 return __helper_1((() => { 
  ...
  __heap[arg1] = null;
      ...
      _js10(arg1) { // JSExportHelpers.__export_4_get_arg_0 
 return (() => { 
  return __heap[arg1][0];
 })() ? 1 : 0; },
      _js11(arg1) { // JSExportHelpers.__export_4_set_result 
 
  __heap[arg1] = null;
 },
      _js65() { // Web.get_window 
 return __make_ref((() => { 
  return window;
 })()); },
      _js68(arg1, arg2) { // Web::Node#append_child 
 
  return __heap[arg1].appendChild(__heap[arg2]);
 },
      _js76(arg1, arg2, arg3) { // Web::CanvasContext#internal_setter_fill_style 
 
  __heap[arg1].fillStyle = __helper_3(arg2, arg3);
 },
      _js77(arg1, arg2, arg3, arg4, arg5) { // Web::CanvasContext#fill_rect 
 
  return __heap[arg1].fillRect(arg2, arg3, arg4, arg5);
 },
      _js79(arg1, arg2, arg3) { // Web::HTMLCanvasElement#get_context 
 return __make_ref((() => { 
  return __heap[arg1].getContext(__helper_3(arg2, arg3));
 })()); },
      _js82(arg1, arg2) { // Web::HTMLCanvasElement#internal_setter_width 
 
  __heap[arg1].width = arg2;
 },
      _js83(arg1, arg2) { // Web::HTMLCanvasElement#internal_setter_height 
 
  __heap[arg1].height = arg2;
 },
      _js84(arg1, arg2, arg3, arg5, arg6) { // Web::HTMLCanvasElement#set_attribute 
 
  return __heap[arg1].setAttribute(__helper_3(arg2, arg3), __helper_3(arg5, arg6));
 },
      _js86(arg1, arg2, arg3) { // Web::HTMLDocument#create_element 
 return __make_ref((() => { 
  return __heap[arg1].createElement(__helper_3(arg2, arg3));
 })()); },
      _js87(arg1) { // Web::HTMLDocument#body 
 return __make_ref((() => { 
  return __heap[arg1].body;
 })()); },
      _js90(arg1) { // Web::Window#document 
 return __make_ref((() => { 
