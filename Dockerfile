...
ENTRYPOINT ["bash", "-c", "lib/js/scripts/build.sh src/shrimp_web.cr -o web/main.wasm && find web -name \"*.js\" | xargs sed -i 's|const wasmSource = \"web/main.wasm\"|const wasmSource = \"main.wasm\"|g' && echo 'Build complete!'"]
